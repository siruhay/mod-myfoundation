...
class MemberShowResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
             ...
             * the record data
             */
            'record' => MyFoundationMember::mapResourceShow($request, $this),

            /**
             * the page setups
             */
            'setups' => [
                'combos' => MyFoundationMember::mapCombos($request, $this),
                ...
                'statuses' => MyFoundationMember::mapStatuses($request, $this),
